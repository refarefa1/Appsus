...
const notes = [
    ...
    { id: "n105", type: "note-img", isPinned: false, info: { url: "assets/img/dog.jpg", title: "" }, style: { color: "#0c0c0c", backgroundColor: "#ad9d26" } },
    ...
    { id: "n107", type: "note-text", isPinned: true, info: { title: "Real Madrid ⚽", txt: "Hala Madrid!" }, style: { color: "#0c0c0c", backgroundColor: "#8a86d9" } },
    ...
    { id: "n114", type: "note-img", isPinned: false, info: { url: "assets/img/mountain.jpg", title: "" }, style: { color: "#0c0c0c", backgroundColor: "#32a852" } },
    { id: "n115", type: "note-todo", isPinned: false, info: { label: "When the course will finally over", todos: [{ txt: "Help My Friend", doneAt: null }, { txt: "Work out", doneAt: 187111111 }] }, style: { color: "#0c0c0c", backgroundColor: "#32a852" } },
    ...
    { id: "n118", type: "note-todo", isPinned: false, info: { label: "Things to do to success this sprint:", todos: [{ txt: "Stay Focused!", doneAt: null }, { txt: "Sleeeeep", doneAt: 187111111 }] }, style: { color: "#0c0c0c", backgroundColor: "#ffffff" } },
    ...
    { id: "n121", type: "note-todo", isPinned: false, info: { label: "Tommorow", todos: [{ txt: "Finsih The Assignment", doneAt: null }, { txt: "Warn my alies", doneAt: 187111111 }] }, style: { color: "#0c0c0c", backgroundColor: "#ffffff" } },
    ...
    { id: "n123", type: "note-img", isPinned: true, info: { url: "assets/img/summer.jpg", title: "Summer" }, style: { color: "#0c0c0c", backgroundColor: "#ffffff" } },
    { id: "n124", type: "note-todo", isPinned: false, info: { label: "", todos: [{ txt: "Skip The Dynamic Componnet Challenge", doneAt: null }, { txt: "Write a song", doneAt: 187111111 }] }, style: { color: "#0c0c0c", backgroundColor: "#ffffff" } },
    ...
    { id: "n127", type: "note-todo", isPinned: false, info: { label: "", todos: [{ txt: "Buy Food", doneAt: null }, { txt: "Fix the computer", doneAt: 187111111 }] }, style: { color: "#0c0c0c", backgroundColor: "#ffffff" } },
    ...
    { id: "n130", type: "note-todo", isPinned: false, info: { label: "", todos: [{ txt: "Talk with my teacher", doneAt: null }, { txt: "Code the game", doneAt: 187111111 }] }, style: { color: "#0c0c0c", backgroundColor: "#ffffff" } },
]
